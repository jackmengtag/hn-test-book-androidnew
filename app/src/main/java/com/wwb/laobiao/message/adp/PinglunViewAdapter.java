...
public class PinglunViewAdapter extends RecyclerView.Adapter<PinglunViewAdapter.ViewHolder> {

    private Context mContext;
    private List<PinglunDataModel> mList;
    private PinglunDataModel data;
    private OnItemClikListener mOnItemClikListener;

    public PinglunViewAdapter(Context context, List<PinglunDataModel> mList) {
        this.mContext = context;
        this.mList = mList;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_pinglun, parent, false);
...
//        public	String  status	;//是否已阅读 0-未阅读 1-已阅读
        ...
        public ViewHolder(View itemView) {
            ...
            parent = (TextView) itemView.findViewById(R.id.iv_parent);
...
//            home_item_movie_list_regions = (TextView) itemView.findViewById(R.id.home_item_movie_list_regions);
        ...
        public void onshow(PinglunDataModel data, int position) {
           ...
           if( data.parent.equals("0"))
           {
               parent.setText("回复了你的视频");
           }
           else
           {
               parent.setText("回复了你的评论");
           }
            content.setText(data.contents);
