...
import com.yangna.lbdsp.common.utils.SizeUtils;
import com.yangna.lbdsp.home.bean.SecondLevelBean;
import com.yangna.lbdsp.widget.SimpleWeakObjectPool;
import com.yangna.lbdsp.widget.TextClickSpans;
import com.yangna.lbdsp.widget.TextMovementMethods;
        ...
        if (!TextUtils.isEmpty(atSomeone)) {
            ...
            builder.setSpan(new TextClickSpans() {
                ...
                public void onClick(@NonNull View widget) {
                    Toast.makeText(BaseApplication.getContext(), atSomeone + " id: " + id, Toast.LENGTH_LONG).show();
                }
