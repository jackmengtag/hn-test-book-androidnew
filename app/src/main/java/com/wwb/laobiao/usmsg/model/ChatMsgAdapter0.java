...
public class ChatMsgAdapter0 extends BaseAdapter {
    Context mContext; public List<ChatModel> mlist;
    private LayoutInflater inflater;
    private MsgInterface msgInterface;

    public ChatMsgAdapter0(Context context, List<ChatModel> mlist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.chatmsgadpter, null);
