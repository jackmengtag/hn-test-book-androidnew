package com.shuiying.videomanage.filters.gpuFilters.utils;
...
import com.shuiying.videomanage.MyApplication;
import com.shuiying.videomanage.filters.gpuFilters.baseFilter.GPUImageFilter;
import com.shuiying.videomanage.filters.gpuFilters.utils.Rotation;
import com.shuiying.videomanage.filters.gpuFilters.utils.TextureRotationUtil;
...
public class OpenGlUtils {
    ...
    public static Bitmap drawToBitmapByFilter(Bitmap bitmap, GPUImageFilter filter,
        ...
        if(rotate){
            FloatBuffer gLCubeBuffer = ByteBuffer.allocateDirect(com.shuiying.videomanage.filters.gpuFilters.utils.TextureRotationUtil.CUBE.length * 4)
                    .order(ByteOrder.nativeOrder())
                    .asFloatBuffer();
            gLCubeBuffer.put(com.shuiying.videomanage.filters.gpuFilters.utils.TextureRotationUtil.CUBE).position(0);

            FloatBuffer gLTextureBuffer = ByteBuffer.allocateDirect(com.shuiying.videomanage.filters.gpuFilters.utils.TextureRotationUtil.TEXTURE_NO_ROTATION.length * 4)
                    .order(ByteOrder.nativeOrder())
                    .asFloatBuffer();
