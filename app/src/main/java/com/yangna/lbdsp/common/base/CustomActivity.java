...
import com.yangna.lbdsp.mine.view.AddInvitationCodeActivity;
...
public class CustomActivity extends AppCompatActivity implements OnCaptureCallback {
    ...
    private void initUI() {
        ...
        tvTitle.setText(getIntent().getStringExtra(AddInvitationCodeActivity.KEY_TITLE));
        ...
        isContinuousScan = getIntent().getBooleanExtra(AddInvitationCodeActivity.KEY_IS_CONTINUOUS, false);
