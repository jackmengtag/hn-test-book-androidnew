...
public class LinearLayoutHeadviewnob3 extends LinearLayout {
    ...
    public LinearLayoutHeadviewnob3(Context context) {
        super(context);
        init(context,null);
    }
    public LinearLayoutHeadviewnob3(Context context, @Nullable AttributeSet attrs) {
        super(context,attrs);
        init(context,attrs);
    }
    private void init(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.layout_ranking_headview_nob2, this);
        headimage=findViewById(R.id.aiv_left);
        imageView=findViewById(R.id.textView0);//textView7
        textViewpraisetotal=findViewById(R.id.textView7);//textView7  textViewpraisetotal
    }
    public LinearLayoutHeadviewnob3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context,attrs);
    }
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public LinearLayoutHeadviewnob3(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//http://lbdsp.com/1605321959258YsNhrG.jpg
        if(strURL==null)
        {
            return;
        }
