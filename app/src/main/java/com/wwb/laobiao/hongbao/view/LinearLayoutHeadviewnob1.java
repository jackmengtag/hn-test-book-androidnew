...
public class LinearLayoutHeadviewnob1 extends LinearLayout {
    ...
    public LinearLayoutHeadviewnob1(Context context) {
        super(context);
        init(context,null);

    }
    public LinearLayoutHeadviewnob1(Context context, @Nullable AttributeSet attrs) {
        super(context,attrs);
        init(context,attrs);
    }
    private void init(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.layout_ranking_headview_nob0, this);
...
//        android:id="@+id/iv_rlay"
    ...
    public LinearLayoutHeadviewnob1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context,attrs);
    }
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public LinearLayoutHeadviewnob1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        try {
//            Bitmap bitmap = Utilswwb.getBitmap(strURL);
