...
import com.yangna.lbdsp.videoCom.AliPlay.AlivcLittleHttpConfig;
import com.yangna.lbdsp.videoCom.AliPlay.BaseVideoListAdapter;
...
import com.yangna.lbdsp.videoCom.AliPlay.PagerLayoutManager;
import com.yangna.lbdsp.videoCom.AliPlay.RecyclerViewEmptySupport;
import com.yangna.lbdsp.videoCom.AliPlay.VideoQuality;
...
//        mListPlayer.enableLog(true);
        ...
        mListPlayer.setOnPreparedListener(new IPlayer.OnPreparedListener() {
            ...
            public void onPrepared() {
                ...
                Log.i("Test" , "isPause=" + isPause + ",isOnBackground=" + isOnBackground);
        ...
        mListPlayer.setOnErrorListener(new IPlayer.OnErrorListener() {
            ...
            public void onError(ErrorInfo errorInfo) {
                ...
                ToastManager.showToast(getContext(), errorInfo.getMsg() );
            }
        });
    ...
    private void init() {
        ...
        pagerLayoutManager.setOnViewPagerListener(new PagerLayoutManager.OnViewPagerListener() {
            ...
            public void onInitComplete() {
                ...
                Log.i("Test", "itemCount=" + itemCount + "-position=" + position + "-isLoadingData=" + isLoadingData + "-isEnd=" + isEnd);
                if (itemCount > DEFAULT_PRELOAD_NUMBER){
        ...
        if (mListPlayer != null) {
            ...
            for (IVideoSourceModel iVideoSourceModel : list) {
                if (iVideoSourceModel.getSourceType() == VideoSourceType.TYPE_STS) {
                    ...
                    Log.d(TAG,"UUID" + iVideoSourceModel.getUUID());
                    ...
                    Log.i("addUrl", "刷新数据url=" + url + ",,,uuid" + uuid);
                }
            }
        }
        if (list.size() < DEFAULT_PRELOAD_NUMBER){
            isEnd = true;
        }else {
            isEnd = false;
        }
        ...
        if (mListPlayer != null) {
            for (IVideoSourceModel iVideoSourceModel : list) {
                if (iVideoSourceModel.getSourceType() == VideoSourceType.TYPE_STS) {
                    ...
                    Log.i("addUrl", "加载更多数据url=" + iVideoSourceModel.getUrlSource().getUri() + ",,,uuid" + iVideoSourceModel.getUUID());
                }
            }
        }
    ...
    public void setOnBackground(boolean isOnBackground) {
        Log.i("Test", "isOnBackground=" + isOnBackground);
