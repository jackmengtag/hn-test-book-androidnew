...
import com.shuiying.videomanage.mediacodec.encodeDecode.InputSurface;
import com.shuiying.videomanage.ui.MagicFilterFactory;
...
public class VideoClipper {
    ...
    public void clipVideo(long startPosition, long clipDur, ArrayList<BaseImageView> views, Resources resources) throws Exception {
        mViews = views;
