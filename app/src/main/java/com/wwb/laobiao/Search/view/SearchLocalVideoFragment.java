...
import com.wwb.laobiao.Search.adp.SearchVideoAdapter;
import com.wwb.laobiao.Search.adp.SearchVideoView;
 ...
 */
public class SearchLocalVideoFragment extends BasePresenterFragment {
...
//        local_ry.setAdapter(adapter);
    ...
    private void initrecview() {
        ArrayList<SearchVideoView> searchIndexViews = new ArrayList<SearchVideoView>();
        for(int i=0;i<22;i++)
        {
            {
                SearchVideoView mSearchIndexView=new SearchVideoView();
        ...
        SearchVideoAdapter adapter = new SearchVideoAdapter(searchIndexViews,context);
        local_ry.setAdapter(adapter);
    }
