 ...
 */
public class SyMediaPlayerWrapper implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener {
    ...
    private List<SyVideoInfo> mInfoList;      //video info list
    private Surface surface;
    private IMediaCallback mCallback;
    private int curIndex;                   //current player index

    public SyMediaPlayerWrapper() {
    ...
    public void setDataSource(List<String> dataSource) {
        ...
        for (int i = 0; i < dataSource.size(); i++) {
            SyVideoInfo info = new SyVideoInfo();
    ...
    public List<SyVideoInfo> getVideoInfo(){
        return mInfoList;
    }
...
//        switchPlayer(mp);
    ...
    public interface IMediaCallback {
         ...
         * @param info
         */
        void onVideoChanged(SyVideoInfo info);
    }
}
