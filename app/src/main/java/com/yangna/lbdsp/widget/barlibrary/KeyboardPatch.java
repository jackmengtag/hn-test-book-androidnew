...
public class KeyboardPatch {
    ...
    private KeyboardPatch(Activity activity, Dialog dialog, String tag) {
        this(activity, dialog, tag, Objects.requireNonNull(dialog.getWindow()).findViewById(android.R.id.content));
    }
    ...
    private KeyboardPatch(Activity activity, Dialog dialog, String tag, View contentView) {
        ...
        this.mDecorView = Objects.requireNonNull(mWindow).getDecorView();
    ...
    static KeyboardPatch patch(Activity activity, Window window) {
        return new KeyboardPatch(activity, window);
    }

    void setBarParams(BarParams barParams) {
