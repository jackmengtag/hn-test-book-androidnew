package com.shuiying.videomanage.mediacodec;
/*
...
import com.shuiying.videomanage.utils.StaticFinalValues;
import com.shuiying.videomanage.view.BaseImageView;
import com.shuiying.videomanage.view.adp.VideoDrawer;
...
//    private TextureRender mTextureRender;
     ...
     */
    public OutputSurface(SyVideoInfo info) {
    ...
    public OutputSurface(SyVideoInfo info, ArrayList<BaseImageView> views, Resources res) {
        mViews = views;
        mResources = res;
        if (info.width <= 0 || info.height <= 0) {
            throw new IllegalArgumentException();
     ...
     */
    private void setup(SyVideoInfo info) {
...
//        mSurfaceTexture = new SurfaceTexture(mTextureRender.getTextureId());
     ...
     * @param clipMode
     */
    public OutputSurface(SyVideoInfo info, int clipMode) {
        if (info.width <= 0 || info.height <= 0) {
            throw new IllegalArgumentException();
        }
//        mTextureRender = new TextureRender(info);
...
//        mDrawer.onDrawFrame(null);
    ...
    public void onVideoSizeChanged(SyVideoInfo info){
