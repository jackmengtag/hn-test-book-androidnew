...
//            holder.addview();
//            holder.layhead.setVisibility(View.VISIBLE);
//            holder.laybody.setVisibility(View.VISIBLE);
...
//            if(position%2!=0)
//              {
//                  holder.layhead.setVisibility(View.GONE);
//                  holder.laybody.setVisibility(View.GONE);
//              }
        }
    }
