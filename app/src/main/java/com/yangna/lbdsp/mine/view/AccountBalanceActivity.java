...
public class AccountBalanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chaochangTOKEN = (String) Objects.requireNonNull(SpUtils.get(AccountBalanceActivity.this, UrlConfig.USERID, ""));
//        new Thread(runnableJinBiXiangQing).start();
//        Log.e("创建时", "拿金币");
    }

    @OnClick(R.id.account_balance_back)//退出当前页面 tixian_daoka
    ...
    public void doTXDK(View view) {
        if (jinbishu.compareTo(bijiaoshu) == -1) {
            Toast toast = Toast.makeText(AccountBalanceActivity.this, "余额不足25，无法提现！", Toast.LENGTH_LONG);
...
//        Log.e("启动时", "拿金币");
    ...
    protected void onResume() {
        ...
        if (chaochangTOKEN.equals("") || chaochangTOKEN == null) {
            Toast toast = Toast.makeText(AccountBalanceActivity.this, "操作过快！请过一会儿再来查看余额！", Toast.LENGTH_LONG);
            LinearLayout layout = (LinearLayout) toast.getView();
            TextView tv = (TextView) layout.getChildAt(0);
            tv.setTextSize(25);
            toast.setGravity(Gravity.CENTER, 0, 0);
...
//                        dialog.dismiss();//销毁加载框
                        ...
                        mJinBiXiangQingHT_net_judge = new Handler() {
                            ...
                            public void handleMessage(@NonNull Message msg) {
                                ...
                                alert1 = new AlertDialog.Builder(AccountBalanceActivity.this).create();
...
//                    toast0.show();
                    ...
                    break;
                case 2://获取失败
                    Toast toast = Toast.makeText(AccountBalanceActivity.this, "获取金币详情 失败", Toast.LENGTH_LONG);
                    LinearLayout layout = (LinearLayout) toast.getView();
                    TextView tv = (TextView) layout.getChildAt(0);
                    tv.setTextSize(20);
                    toast.setGravity(Gravity.CENTER, 0, 0);
