...
import com.yangna.lbdsp.videoCom.AliPlay.image.ImageLoaderImpl;
import com.yangna.lbdsp.videoCom.AliPlay.image.ImageLoaderOptions;
import com.yangna.lbdsp.videoCom.AliPlay.image.ImageLoaderRequestListener;
...
public abstract class BaseVideoListAdapter<VH extends BaseVideoListAdapter.BaseHolder, T extends IVideoSourceModel> extends RecyclerView.Adapter<VH> {
    ...
    public void onBindViewHolder(final VH holder, int position) {
        ...
        Log.d(TAG, "onBindViewHolder positfion:" + position);
    ...
    public int getItemCount() {
        Log.d("AlivcVideoListView", "getItemCount" + list.size());
