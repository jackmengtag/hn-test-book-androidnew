...
import com.wwb.laobiao.Search.view.SearchIndexView;
...
public class SearchIndexAdapter extends RecyclerView.Adapter<SearchIndexAdapter.ViewHolder> {
    private  ArrayList<SearchIndexView> searchIndexViews;
    private Context mContext;
    public SearchIndexAdapter(ArrayList<SearchIndexView> searchIndexViews, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_searchindex,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       if(searchIndexViews!=null)
       {
           ...
           {
               SearchIndexView mvv = searchIndexViews.get(position);
               switch (mvv.sky)
               {
                   case 0:
